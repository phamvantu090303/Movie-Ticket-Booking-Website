                            ...
                            <table id="tableA" class="table table-bordered">
                                ...
                                <tbody>
                                    <div class="input-group mb-3">
                                        <input v-on:keyup.enter v-model="search.tt" type="text" class="form-control" placeholder="Nhap vao tim kiem"  >
                                         <button v-on:click="Search()" class="input-group-text btn btn-primary" >Search</button>
                                    </div>
    ...
    $(document).ready(function() {
        new Vue({
            ...
            methods: {
                Search(){
                    axios
                        .post('{{Route("taiKhoanSearch")}}', this.search)
                        .then((res) => {
